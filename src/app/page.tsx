      ...
      >
        <nav className="container mx-auto px-4 sm:px-6 py-3 sm:py-4">
          <div className="flex items-center justify-between">
            ...
            {/* Desktop Navigation */}
            <div className="hidden lg:flex items-center space-x-6 scroll-smooth">
              <a
                href="/"
                onClick={() => {}}
              ...
              >
                Home
                <span className="absolute -bottom-1 left-1/2 w-0 h-0.5 bg-pink-400 transition-all duration-300 group-hover:w-full group-hover:left-0"></span>
              </a>
        ...
        {/* Mobile Menu */}
        <div 
          className={`lg:hidden absolute top-full left-0 right-0 bg-white/98 backdrop-blur-md shadow-2xl border-t border-pink-200 transition-all duration-300 ${
        ...
        >
          <div className="container mx-auto px-4 py-6">
            <a
              ...
              className="block px-4 py-3 text-gray-700 hover:text-pink-500 hover:bg-pink-50 rounded-lg font-medium transition-all duration-200"
            >
              Home
            </a>
